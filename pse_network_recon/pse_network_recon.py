...
init_parser = argparse.ArgumentParser(description='havoc playbook - PowerShell Empire Builtin Network Recon')
...
config.read('havoc-playbooks/pse_network_recon/pse_network_recon.ini')
...
for section in config.sections():
    if section != 'c2_task':
        ...
        if module_config['Enable'].lower() == 'true':
            ...
            try:
                module_results = h.execute_agent_module(c2_task_name, c2_agent_name, module, m_config, completion_string=comp_str)
